"""
Django settings for askme_cherepnin project.
...
INSTALLED_APPS = [
    ...
    'app',  # added lib app which contains models.py
]
...
ROOT_URLCONF = 'askme_cherepnin.urls'
...
WSGI_APPLICATION = 'askme_cherepnin.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.0/ref/settings/#databases

DATABASES = {  # Joined to Postgres
    'default': {
